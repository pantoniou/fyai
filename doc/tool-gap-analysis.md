...
vendors `libvterm` (`third_party/libvterm`) to test its own display, thus the
dependency is present. The work that stays is the design: how much history to
keep, what to do about the alternate screen, and how to put a screen into a
message.
