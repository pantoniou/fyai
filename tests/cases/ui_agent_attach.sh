...
# Attachment reaches a grandchild and keeps its final output after completion.
set -eu
...
FYAI_PTY_DURING_INPUT="/branch attach main/agent:child/agent:grandchild" \
